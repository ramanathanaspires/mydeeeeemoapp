...
public:
    ...
    /**
         * \fn   void serialPortFlushing(const QString &r_const_strPortName) const
         * \brief This function is used to flush the UART port.
         * \param[in] r_const_strPortName used to set the port name to flush.
         */
    void serialPortFlushing(const QString &r_const_strPortName) const;
