...
//    /**
//         * \fn bool DBConfiguration(QString &r_HostName,QString &r_UserName,QString &r_Password) const
//         * \brief This function is used to get the configuration of the Database.
//         * it will give the configuration details of the Database.
//         * \param[out] QString used to get the Database configuration details.
//         * \return It returns true, if configuration exists; otherwise returns false.
//         *
//         * \sa see also QString.
//         */
//    void setDBConfiguration(const QString &r_const_strHostName, const QString &r_const_strUserName, const QString &r_const_strPassword) const;
...
//         * \brief This function is used to get the configuration of the Database.
//         * it will give the configuration details of the Database.
//         * \param[out] r_HostName used to get the HostName of the Database.
//         * \param[out] r_UserName used to get the User Name of the Database.
//         * \param[out] r_Password used to get the Password of the Database.
//         * \return It returns true, if configuration exists; otherwise returns false.
//         */
//    bool DBConfiguration(QString &r_HostName,QString &r_UserName,QString &r_Password) const;
    ...
    /**
         * \var float m_nBatteryValue
         * \brief used to store the last battery value.
         */
    float m_nBatteryValue;
...
//    /**
//         * \fn virtual void batteryValue(float fvalue)
//         * \brief In your reimplementation of this function to receive the battery level and percentage.
//         * Reimplement this if you don't want to use the default HHC80xx panel.
//         * \param[in] nLevel it gives the battery level. It would be 0 to 5.
//         * \param[in] nPercentage it gives the battery percentage. It would be 0 to 100.
//         */
//    virtual void batteryValue(float fvalue);
