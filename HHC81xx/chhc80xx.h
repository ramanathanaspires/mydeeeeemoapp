...
public:
    ...
    /**
         * \fn void coProcessorVersion(QString &r_strVer,QString &r_strDateTime)
    ...
    /**
           * \fn bool setGPRSAPN(QString APNName) const
    ...
    /**
         * \fn bool capsLockStatus(bool &r_bCapsLock) const
    ...
    /**
         * \fn bool EnableGPRSModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnableRFIDModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnableGPSModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnableSAMModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnableCAMERAModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnableBARCODEModule(bool bSwitchOn) const
    ...
    /**
         * \fn bool EnablePRINTERModule(bool bSwitchOn) const
    ...
    /**
         ...
         * \return It returns true,  if this function executed successfully; otherwise returns false.
         */
    bool EnableHub(bool bSwitchOn) const;
    ...
    /**
             ...
             * \return It returns true, if this function executed successfully; otherwise returns false.
             */
    bool EnableSmartCardSlot(const E_SmartcardSlot r_eSmartCard) const;
    ...
    /**
          * \fn bool EnableWIFIModule(bool bSwitchOn) const
          ...
          * \return It returns true,  if this function executed successfully; otherwise returns false.
          */
    bool EnableWIFIModule(bool bSwitchOn) const;
    ...
    /**
         * \fn bool setDateTime(const QDateTime &r_const_dateTimeDT) const
    ...
    /**
            * \fn QString gsm_ModuleVersion();
            * \brief This function is used to get the version number of the GSM module.
            * \return It returns the version number of the GSM module as a string value.
            */
    QString gsm_ModuleVersion();
