...
public:
    ...
    /**
         * \fn bool setMachineId(QString strmachineid) const
         * \brief This Function is used to set the Device Machine Id through Software
         * \return It returns true if it sets machineid else False.
         */
    bool setMachineId(QString strMachineId) const;
    ...
    /**
         ...
         * \brief This function is used to set the Keypad For Function Test.
    ...
    /**
                ...
                */
    bool getGPSdata(QString &r_strLatitude,QString &r_strLongitude,QString &r_strAltitude,QString &r_strNo_of_sat,QString &r_strSpeed);
    /**
