...
CHHC80xx::CHHC80xx()
{
    ...
    if ( gserverObj != NULL )
    {
        ...
        QBrush brush;
        //Load Logo for initial Screen from usr/share/logo
    ...
    if ( gbFirsCall )
    {
        ...
        //        QString str1,str2;
        //        getGPRSGPSdata(str1,str2);
        //        qDebug()<<"\r chh constr"<<str1<<"\n chhc const..>>"<<str2;
    }
    else
    {
...
bool CHHC80xx::EnableWIFIEModule(bool bSwitchOn) const
{
    //  if ( gstrDeviceModel.contains("HHC-7") ) {
    gLoadIntoSharedPIC(const_strSTARTED);
...
bool CHHC80xx::EnableHub(bool bSwitchOn)
{
    ...
    //        MassStorage =eNone;
    //        ghhc80xxServerObj->setGadgetConfiguration(Gadeget,MassStorage);
...
bool CHHC80xx::EnableSmartCardSlot(const E_SmartcardSlot r_eSmartCard)
{
    gLoadIntoSharedPIC(const_strSTARTED);
