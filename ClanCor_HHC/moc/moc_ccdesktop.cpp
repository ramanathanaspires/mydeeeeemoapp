...
**
** Created: Tue Feb 11 18:09:48 2014
...
static const char qt_meta_stringdata_CCDesktop[] = {
    "CCDesktop\0\0,\0CloseApplicaton(int,QProcess::ExitStatus)\0"
...
const QMetaObject &CCDesktop::getStaticMetaObject() { return staticMetaObject; }
...
int CCDesktop::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: CloseApplicaton((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
